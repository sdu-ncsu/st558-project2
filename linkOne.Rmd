...
newsPopTrain <- diabetesData[as.vector(trainIndex),];
newsPopTest <- diabetesData[-as.vector(trainIndex),];
```
...
g0 + geom_histogram(binwidth = 1000) + ggtitle('Histogram for Number of Shares') + ylab('Number of Shares') + xlab('Shares')
...
Below is a comparison of the two methods. Both have relatively high root mean square errors.
